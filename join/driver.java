...
public class driver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		MultipleInputs.addInputPath(conf, AInputPath, TextInputFormat.class, mapper1.class);
		MultipleInputs.addInputPath(conf, BInputPath, TextInputFormat.class, mapper.class);
